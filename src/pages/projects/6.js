...
import { projectDetailsArea } from "@/data/projectContent6";
import { Col, Container, Image, Row } from "react-bootstrap";

import { projectDetailsTabBtns } from "@/data/projectContent6";
...
import { projectDetailsComments } from "@/data/projectContent6";

const { idc, comments } = projectDetailsComments;

import { projectDetailsFaq } from "@/data/projectContent6";
import Faqs from "@/components/FaqArea/Faqs";


import { projectDetailsSidebar } from "@/data/projectContent6";
const { info, perks } = projectDetailsSidebar;

import { projectDetailsStory } from "@/data/projectContent6";
