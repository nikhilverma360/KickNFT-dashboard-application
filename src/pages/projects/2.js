...
import { projectDetailsArea } from "@/data/projectContent2";
import { Col, Container, Image, Row } from "react-bootstrap";

import { projectDetailsTabBtns } from "@/data/projectContent2";
...
import { projectDetailsComments } from "@/data/projectContent2";

const { idc, comments } = projectDetailsComments;

import { projectDetailsFaq } from "@/data/projectContent2";
import Faqs from "@/components/FaqArea/Faqs";


import { projectDetailsSidebar } from "@/data/projectContent2";
const { info, perks } = projectDetailsSidebar;

import { projectDetailsStory } from "@/data/projectContent2";
