...
import { creatorDetailsArea } from "@/data/creatorContent3";
import { Col, Container, Image, Row } from "react-bootstrap";

import { creatorDetailsTabBtns } from "@/data/creatorContent3";
...
import { creatorDetailsComments } from "@/data/creatorContent3";

const { idc, comments } = creatorDetailsComments;

import { creatorDetailsFaq } from "@/data/creatorContent3";
...
import { creatorDetailsSidebar } from "@/data/creatorContent3";
const { info, perks } = creatorDetailsSidebar;

// import ProjectDetailsStory from "@/components/ProjectsArea/ProjectDetails/ProjectDetailsStory";
import { creatorDetailsStory } from "@/data/creatorContent3";
...
const { faqs, id } = creatorDetailsFaq;
...
const ProjectDetailsPark = ({ perk = {} }) => {
    ...
    return (
        ...
        >
            ...
            <span>Supporter ({sold} sold already)</span>
            <p>
                ${amount} ({off}% OFF)
            </p>
            <ul>
...
const SingleProject = () => {
    ...
    return (
        <Layout>
            <Header />
            <PageTitle title=" Creators" page="Explore" />
                        ...
                        <Col lg={8}>
                            <div className="tab-btns">
                                <ul className="nav nav-pills" id="pills-tab" role="tablist">
                                    {creatorDetailsTabBtns.map(({ id, name }) => (
